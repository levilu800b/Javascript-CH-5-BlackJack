...
document.querySelector('#blackjack-stand-button').addEventListener(
	'click',
	dealerLogic
);
...
function showCard(card, activePlayer) {
	if (activePlayer['score'] <= 21) {
		...
		document.querySelector(activePlayer['div']).appendChild(
			cardImage
		);
		hitSound.play();
	}
